System.register(["aurelia-framework", "strman"], function (exports_1, context_1) {
    ...
    var aurelia_framework_1, strman_1, SafeTruncateValueConverter;
    return {
        setters: [
        ...
        execute: function () {
            SafeTruncateValueConverter = (function () {
            ...
            exports_1("SafeTruncateValueConverter", SafeTruncateValueConverter);
        }
    };
});
