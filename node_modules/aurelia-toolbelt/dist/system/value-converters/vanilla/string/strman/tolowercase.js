System.register(["aurelia-framework", "strman"], function (exports_1, context_1) {
    ...
    var aurelia_framework_1, strman_1, ToLowerCaseValueConverter;
    return {
        setters: [
        ...
        execute: function () {
            ToLowerCaseValueConverter = (function () {
            ...
            exports_1("ToLowerCaseValueConverter", ToLowerCaseValueConverter);
        }
    };
});
