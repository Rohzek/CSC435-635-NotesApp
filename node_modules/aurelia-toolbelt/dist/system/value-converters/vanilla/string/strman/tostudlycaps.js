System.register(["aurelia-framework", "strman"], function (exports_1, context_1) {
    ...
    var aurelia_framework_1, strman_1, ToStudlyCapsValueConverter;
    return {
        setters: [
        ...
        execute: function () {
            ToStudlyCapsValueConverter = (function () {
            ...
            exports_1("ToStudlyCapsValueConverter", ToStudlyCapsValueConverter);
        }
    };
});
