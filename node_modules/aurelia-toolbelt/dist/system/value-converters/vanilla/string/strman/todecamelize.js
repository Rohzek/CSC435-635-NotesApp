System.register(["aurelia-framework", "strman"], function (exports_1, context_1) {
    ...
    var aurelia_framework_1, strman_1, ToDecamelizeValueConverter;
    return {
        setters: [
        ...
        execute: function () {
            ToDecamelizeValueConverter = (function () {
            ...
            exports_1("ToDecamelizeValueConverter", ToDecamelizeValueConverter);
        }
    };
});
