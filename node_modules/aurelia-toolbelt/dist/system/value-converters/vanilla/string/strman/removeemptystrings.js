System.register(["aurelia-framework", "strman"], function (exports_1, context_1) {
    ...
    var aurelia_framework_1, strman_1, RemoveEmptyStringsValueConverter;
    return {
        setters: [
        ...
        execute: function () {
            RemoveEmptyStringsValueConverter = (function () {
            ...
            exports_1("RemoveEmptyStringsValueConverter", RemoveEmptyStringsValueConverter);
        }
    };
});
