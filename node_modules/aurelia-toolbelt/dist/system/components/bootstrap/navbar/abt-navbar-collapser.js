System.register(["aurelia-framework", "aurelia-templating"], function (exports_1, context_1) {
    ...
    var aurelia_framework_1, aurelia_templating_1, BootstrapNavBarCollapser;
    return {
        setters: [
        ...
        execute: function () {
            BootstrapNavBarCollapser = (function () {
            ...
            exports_1("BootstrapNavBarCollapser", BootstrapNavBarCollapser);
        }
    };
});
