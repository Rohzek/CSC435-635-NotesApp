System.register(["./../../../utilities/vanilla/sharedIndex", "aurelia-framework", "../../../utilities/vanilla/uuid"], function (exports_1, context_1) {
    ...
    var sharedIndex_1, aurelia_framework_1, uuid_1, IdCustomAttribute;
    return {
        setters: [
        ...
        execute: function () {
            IdCustomAttribute = (function () {
                ...
                IdCustomAttribute = __decorate([
                    ...
                    __metadata("design:paramtypes", [Element, sharedIndex_1.SharedIndex, uuid_1.Uuid])
                ], IdCustomAttribute);
                return IdCustomAttribute;
            }());
            exports_1("IdCustomAttribute", IdCustomAttribute);
        }
    };
});
